...
async def quality_flags_from_csv(file: UploadFile = File(...)) -> dict[str, dict]:
    """
    Принимает CSV-файл и возвращает полный словарь флагов качества,
    который выдаёт compute_quality_flags (включая эвристики из HW03).
    """
